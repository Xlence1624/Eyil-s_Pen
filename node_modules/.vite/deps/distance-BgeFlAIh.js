...
//#endregion
export { scrapeMotionValuesFromProps$1 as $, isGenerator as $n, vh as $r, isPrimaryPointer as $t, removePointDelta as A, reverseEasing as Ai, setTarget as An, calcGeneratorDuration as Ar, initPrefersReducedMotion as At, copyAxisInto as B, pipe as Bi, getValueTransition as Bn, mixColor as Br, visualElementStore as Bt, axisEqualsRounded as C, circIn as Ci, getOptimisedAppearId as Cn, convertOffsetToTimes as Cr, convertBoxToBoundingBox as Ct, removeAxisDelta as D, backIn as Di, addValueToWillChange as Dn, inertia as Dr, VisualElement as Dt, isDeltaZero as E, anticipate as Ei, camelToDash as En, interpolate as Er, DOMVisualElement as Et, calcRelativeAxisPosition as F, velocityPerSecond as Fi, getVariableValue as Fn, mixArray as Fr, isVariantNode as Ft, SVGVisualElement as G, isNumericalString as Gi, calcChildStagger as Gn, analyseComplexValue as Gr, findValueType as Gt, checkVariantsDidChange as H, memo as Hi, MotionValue as Hn, mixNumber$1 as Hr, createAxisDelta as Ht, calcRelativeBox as I, millisecondsToSeconds as Ii, parseCSSVariable as In, mixComplex as Ir, variantPriorityOrder as It, isSVGTag as J, warning as Ji, acceleratedValues as Jn, hsla as Jr, resize as Jt, scrapeMotionValuesFromProps as K, MotionGlobalConfig as Ki, AsyncMotionValueAnimation as Kn, complex as Kr, isSVGSVGElement as Kt, calcRelativePosition as L, secondsToMilliseconds as Li, animateMotionValue as Ln, mixObject as Lr, variantProps as Lt, calcBoxDelta as M, cubicBezier as Mi, positionalKeys as Mn, generateLinearEasing as Mr, prefersReducedMotion as Mt, calcLength as N, hasWarned as Ni, resolveVariant as Nn, mix as Nr, updateMotionValuesFromProps as Nt, removeAxisTransforms as O, backInOut as Oi, isWillChangeMotionValue as On, spring as Or, getFeatureDefinitions as Ot, calcRelativeAxis as P, warnOnce as Pi, resolveVariantFromProps as Pn, getMixer as Pr, isControllingVariants as Pt, HTMLVisualElement as Q, removeItem as Qi, applyGeneratorOptions as Qn, px as Qr, isElementTextInput as Qt, isNear as R, SubscriptionManager as Ri, isTransitionDefined as Rn, invisibleValues as Rr, isVariantLabel as Rt, axisEquals as S, easeOut as Si, animateTarget as Sn, keyframes as Sr, convertBoundingBoxToBox as St, boxEqualsRounded as T, circOut as Ti, optimizedAppearDataId as Tn, fillOffset as Tr, Feature as Tt, createAnimationState as U, isZeroValueString as Ui, collectMotionValues as Un, mixImmediate as Ur, createBox as Ut, copyBoxInto as V, noop as Vi, resolveTransition as Vn, mixLinearColor as Vr, createAxis as Vt, getVariantContext as W, isObject as Wi, motionValue as Wn, hslaToRgba as Wr, createDelta as Wt, buildSVGAttrs as X, addUniqueItem as Xi, NativeAnimationExtended as Xn, percent as Xr, press as Xt, camelCaseAttributes as Y, clamp as Yi, makeAnimationInstant as Yn, degrees as Yr, isSVGElement as Yt, buildSVGPath as Z, moveItem as Zi, NativeAnimation as Zn, progressPercentage as Zr, isElementKeyboardAccessible as Zt, mixValues as _, easingDefinitionToFunction as _i, dimensionValueTypes as _n, fillWildcards as _r, transformBox as _t, DocumentProjectionNode as a, number as ai, cancelMicrotask as an, supportsScrollTimeline as ar, pixelsToPercent as at, aspectRatio as b, easeIn as bi, animateVisualElement as bn, getFinalKeyframe as br, hasScale as bt, propagateDirtyNodes as c, isCSSVariableName as ci, getValueAsType as cn, setStyle as cr, buildTransform as ct, resolveMotionValue as d, cancelFrame as di, DOMKeyframesResolver as dn, flushKeyframeResolvers as dr, applyAxisDelta as dt, vw as ei, isNodeOrChild as en, startWaapiAnimation as er, isForcedMotionValue as et, delayInSeconds as f, frame as fi, getAnimatableNone as fn, transformPropOrder as fr, applyBoxDelta as ft, animateSingleValue as g, stepsOrder as gi, transformValueTypes as gn, readTransformValue as gr, transformAxis as gt, addDomEvent as h, createRenderBatcher as hi, numberValueTypes as hn, parseValueFromTransform as hr, scalePoint as ht, rootProjectionNode as i, alpha as ii, isDragging as in, supportsLinearEasing as ir, correctBorderRadius as it, calcAxisDelta as j, mirrorEasing as ji, isKeyframesTarget as jn, maxGeneratorDuration as jr, hasReducedMotionListener as jt, removeBoxTransforms as k, backOut as ki, isMotionValue as kn, createGeneratorEasing as kr, setFeatureDefinitions as kt, globalProjectionState as l, isCSSVariableToken as li, resolveElements as ln, isCSSVar as lr, measurePageBox as lt, compareByDepth as m, frameSteps as mi, getDefaultValueType as mn, defaultTransformValue as mr, applyTreeDeltas as mt, distance2D as n, rgbUnit as ni, setDragLock as nn, supportedWaapiEasing as nr, scaleCorrectors as nt, cleanDirtyNodes as o, scale as oi, microtask as on, supportsViewTimeline as or, renderHTML as ot, FlatTree as p, frameData as pi, defaultValueTypes as pn, transformProps as pr, applyPointDelta as pt, renderSVG as q, invariant as qi, supportsBrowserAnimation as qn, color as qr, statsBuffer as qt, HTMLProjectionNode as r, rgba as ri, isDragActive as rn, cubicBezierAsString as rr, correctBoxShadow as rt, createProjectionNode as s, containsCSSVariable as si, isHTMLElement as sn, supportsFlags as sr, buildHTMLStyles as st, distance as t, hex as ti, hover as tn, mapEasingToNativeEasing as tr, addScaleCorrector as tt, NodeStack as u, time as ui, cornerRadiusProps as un, KeyframeResolver as ur, measureViewportBox as ut, buildProjectionTransform as v, isBezierDefinition as vi, findDimensionValueType as vn, JSAnimation as vr, translateAxis as vt, boxEquals as w, circInOut as wi, optimizedAppearDataAttribute as wn, defaultOffset as wr, transformBoxPoints as wt, axisDeltaEquals as x, easeInOut as xi, animateVariant as xn, defaultEasing as xr, hasTransform as xt, eachAxis as y, isEasingArray as yi, testValueType as yn, animateValue as yr, has2DTranslate as yt, copyAxisDeltaInto as z, progress as zi, getDefaultTransition as zn, mixVisibility as zr, isAnimationControls as zt };
