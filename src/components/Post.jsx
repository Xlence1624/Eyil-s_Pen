...
const Post = () => {
  return (
    <div className="py-5 flex flex-col justify-between bg-white">
            <form className="md:px-10 px-4 space-y-5 max-w-lg">
                <div>
                    <p className="text-base font-medium">Post Hero Image</p>
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <select id="category" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40">
                        ...
                        {[{ name: 'Faith' }, { name: 'Work' }, { name: 'Finance' },{ name: 'Relationships' },{ name: 'Life' }].map((item, index) => (
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        <label className="text-base font-medium" htmlFor="product-price">Date</label>
                        <input id="product-price" type="date" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                    </div>
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        <label className="text-base font-medium" htmlFor="offer-price">Read time</label>
