...
import office2 from '../assets/view-modern-office.jpg'

import office from '../assets/green-business-meeting-working-room-office-building-with-bookshelf.jpg'
...
//     readTime: "5 min read",
//   image: blog_pic_3,
//     slug: "The complexity of work life",
//   }, {
//     id: 5,
//     category: "Relationships",
//     title: "Giving ‘IT’ Another Shot",
//     readTime: "5 min read",
//   image: blog_pic_2,
//     slug: "sometimes-love-is-not-the-problem",
//   }, {
...
export const blog_data = [
    {
        ...
        "title": "HONESTY? EMPLOYABILITY?",
        "description": "<p>You know, I was thinking to myself, that someday soon, when I’m an employer of labour and/or when I’m at the level where I interview young minds for a job, <br>I’d wait, after they’re done presenting themselves as the best fit, and ask “…but it seems you are doing well at your current place, so, why do you want to leave?” Or “…but there’s news that your current place is a good place to work, so, why do you want to leave?</p> <p>I’m asking, not because I want to have my lick back, and judge them by it, like someone recently did me, but because I want to genuinely listen, and hear their unsaid words, like someone recently did me (been at the end of both barrels…)…’cos trust me, you might just see the glimmer disappear from your faces, a lowered tone, a crack in their voice.</p> <p> Not because they don’t know why they’re leaving, but how do they explain it to you without you branding them, judging them. Since it’s UNPROFESSIONAL and bad marketing of yourself to say “the work-environment became a little too toxic for me”, “I had a new boss who was more difficult to work with” “the work culture did not allow me to have an attempt at balancing life and work”…even career coaches and AI chatbots advise against such answers… </p> <p> I mean, those answers are often interpreted as though you're not as resilient or high-performing as you've presented yourself to be in the last 45minutes of the interview. And trust me, they know, you can’t play victim at life’s games, but some times, most times, they know - they know when you’re the victim at that particular game,  when you’re just one caught in a web. </p> <p>Especially if you’re still shuffling the same industry…Sometimes, they’ve been caught in the same web as you, but aren’t we all just on our high horses…“…do you mean we have lesser workload here?” “…do you think we don’t chase performance here?”Maybe it’s a valid question to evaluate you, judge professionalism, fact check your reasoning; but it can easily be a trap rather than an invitation to understand someone's story, especially when the answer once it does not have that ‘go getter, driven’ loudly inscribed on it.</p>   <p>*************second thought ************</p> <p>I WON’T!!!I WILL NOT DO IT!!!To what point?“…but it seems you are doing well at your current place, so, why do you want to leave?”Did they not know about that? Did they not just spend the last 45minutes tooting their own horn to you, convincing you they’re your best bet? Ofcourse, they know they’re doing well, and they know about their application to yours, they’re not absent at the interview. They’re there with you!!! Even if the application was sent in proxy, it wasn’t their clone you just finished addressing (well, except this AI thing is now crazy and we now scam our way out interviews too 🤷🏽‍♀️)“…but there’s news that your current place is a good place to work, so, why do you want to leave?”If you can know that much, then they do too.</p> And, maybe with a little bit more information than you do. What if the title was a sham? Or what if there’s something they need now, that your organization might just be able to give them, which they cannot just get as fast at their current place? And do you mean your place is the toxic place to work? Well, maybe it is, ‘cos that question might just be the ‘ticker’ they need…</p> <p>All that to say, they know they’re doing well there, they’d just rather not stay, but they’ve chosen to leave and come to yours. And, don’t you need staff afterall? Don’t you need high flyers too? And they know they’re leaving their ‘good place to work’, maybe they just want to leave their comfort zone for a bitPft!All that to say, I don’t know the conclusion to draw from this, just, draw your conclusion, do with the article what you wish. <p> As the triggering questions or not, it’s your call, your recruitment process, your organization!!!All I know is, mental health, has “health” with it for a reason. And health, is wealth, hence, should be valid enough.<br>Maybe the question shouldn’t be why they're leaving. What if it’s focused on if your organization can become what they're looking for? What would you want here that wasn’t there? Might just be less of a trigger, arriving at the same insight. Who knows, they might even tell you why they’re leaving.<br>But, what do I know? Till I sit, on an interview panel!!!Peace!!!!</p>",
        "category": "work" || "Everything inbetween",
        "image": blog_pic_1,
        "createdAt": "2026-07-21T07:06:37.508Z",
        "updatedAt": "2026-07-28T08:26:29.750Z",
        "__v": 0,
        "isPublished": true,
        "subTitle": "My employer of labour mental journey.",
        "readTime": "10 Minutes"
    },
    {
        "_id": "6805ef08d8f584af5da78d39",
        "title": "Giving ‘IT’ Another Shot",
        "description": "<p>So, yeah … whoever knows me knows how many shots I’ve given to consistent writing </p><p>Had a blogspot <br>Used twitter <br> Maybe even a podcast I never saw through… <br>Used a writing app<br> Even tried a novel once (doubt anyone knew this, my secret…)<br>I only ever did one chapter, that’s if I finished it…</p><p>So, yeah, giving ‘IT’ another shot … or is it them?</p><p>Them, ‘cos healthy living was another thing I said I was gon’ be giving a shot last year<br>I tried, trust me, I did <br>Subscribed to a gym twice…2 months<br>…safe to say there was just a day in each month</p><p>So, again ‘yeah’, wanna see if I’ll be able to be a lil more consistent in both, by carrying my lil circle along <br>…my circle is gon’ be whoever chooses to read these posts sometimes…</p><p>So, I’mma be posting on my gym stories… giving almost daily updates, and then every other thing</p><p>I’ve never been a fan of writing about my personal life<br>Neither am I so much of a fictional writing <br>Prior to now, I’ve always kinda blended both, 1% non-fiction, 99% fiction <br>I tagged it ‘non-fiction fictional writing’</p><p>…now, I think we’ll be doing more nonfiction <br>Won’t allocate percentage yet, let’s ride together</p><p>…the corporate world would influence me saying ‘regards’, but I did say y’all are my lil circle, so, I choose</p> <p>Peace, lovers 🤗🤗</p>",
        "category": "Work" || "Everything inbetween",
        "image": blog_pic_2,
        "createdAt": "2025-03-11T07:08:56.214Z",
    ...
    },
    {
        ...
        "title": "Free Joy, NOT Cheap Joy",
        "description": "<p>So... all that info is in previous post is so that I get the platform to drop something again (sense 😉🙂).</p><p>My loves, JOY is free and available to all BUT it sure AIN'T CHEAP.</p><p>So, my convalescent self was on my way to the hospital for the last batch of my injections (my butts is sure on fire from previous ones, but what can a baby girl do 🙁☹️</p><p>Anyway...</p> <p>This driver, looking all tired, rough and all (a Lagos hustler driver ofcourse. GOD PLEASE HELP US ALL WITH NO SILVER SPOON)<br>Halfway into the drive (less than 10minutes drive anyway), after his bus was hit by a police officer for 'illegal parking'and a threat to deflate his tires (again, this' Lagos, and the heart of it ofcos...)</p><p>...back on track...</p><p>Young man baby boy did put more volume to his music (not new, I know, we're all used to noise in this Lagos, sadly...)</p><p>...anyway...</p><p>...as I was saying... bro started to groove to the music, hands off the wheels, on a BRT express lane 😳😲 (Apologies to those who don't know what BRT is 🌚...)</p><p>Trust me, I sure wanted to caution him cos I was on the front passenger's seat yeah? But bro, I couldn't bring me to do it. I just smiled and realized all over again; JOY IS FREE BRO, JOY IS FREE SIS.</p><p>Man has sure had a long day, will still have a long day despite that it was evening then (it doesn't get dark in this part of Nigeria you know? 😉</p><p>Long story short, I started dancing a lil on that seat myself, smiling 🤣🤣</p><p>Summary is...in it all, the struggles and hustles, find your joy and let nothing ever take it away from you...</p><p>PS: THE BEST FORM OF JOY IS FOUND IN JESUS CHRIST you know? Well, now you do 😊</p><p>And yes, we're still here... I AM!!! 🤷🏻‍♀️</p><p>But don't drive HANDS FREE, except it's a tech/robot car or whatever 😊</p><p>Love love,<br>#EYILZ!!! 😚🥰🥰🥰🥰</p>",
        "category": "faith",
        "image": blog_pic_10,
        "createdAt": "2021-09-25T07:24:26.853Z",
    ...
    },
    {
        ...
        "title": "Documentary Writing yeah? 🌚",
    ...
    },
    {
        ...
        "title": "Can a woman really do what a man can do?",        "description": " <p>'What a man can do, a woman can do' is one saying females are quick to. Some of us even make ours longer with a few extra words, 'what a man can do, a woman can do MUCH MORE BETTER.' Smiles. Why do I feel you guys think I'm talking about me? Well, maybe...but that was in the past. Hey!!! It doesn't mean the statement is false, more like, it's a regular one, no biggie about it.<p><p>It's like saying 'JUICE/ANY KIND OF DRINK IS SWEETER THAN WATER.' Like, who doesn't know that? But does that mean you can forever delete water from your list? It's a NO!!! They all serve their purpose, they are complimentary, not unhealthy rivals. In the same vein, <strong>MEN and WOMEN ARE ON EARTH TO COMPLIMENT ONE ANOTHER, THEY ARE NOT COMPETITORS!!!</strong></p><p>Maybe my water/juice analogy doesn't even qualify it, cos we can still decide to do away with the supplement (juice), but never with water. I said my analogy may have a loophole 'cos no one gender can do without the other right? If not, God wouldn't have made two physical form of man.</p><p>But also, critically looking into it, what type of boring world would we have had without water supplements? That's why God allowed even palmwine, the most natural and waterlike supplement, and ofcourse, today, we have too many that they can cause us health issues 🤷🏻‍♀️</p><p>My point? Men and women aren't competitors. Trust me, every right thinking woman want to have a man to shelter her in every form of the word. I've never doubted that. (You can read up the last paragraph of my second post here). But one gender thinking the world revolve round them and that they can do and undo, illtreating, cheating, silencing the other gender? THAT will never go well with me. Annoying thing is, men who do/think these are the laziest, unruly, broke set of people. All they have is their 'manhood', so you wouldn't blame them when they start ranting.<br>And against such, I think we all should rise and fight. Feminism, like I'll always say, is <strong>NEVER</strong> a dumb course. It is in perverted feminism that you <strong>WILL NEVER</strong> find me.</p><p>And yes, feminism is a thing 'cos it's way more easier for women and the girl child to not have a voice or lose it than it is for men. No one is saying guys don't have their share of things, just that statistically, theirs is lesser than that of females. Added to the fact that men always wanna 'man up' and die slowly...</p><p>Here are a few links to statistical review on the preceding paragraph. You can also read up more... <br><a href='https://www.thehotline.org/resources/statistics/'> https://www.thehotline.org/resources/statistics/</a><br> <a href='https://en.m.wikipedia.org/wiki/Domestic_violence_against_men'>https://en.m.wikipedia.org/wiki/Domestic_violence_against_men</a> <br> <a href='https://ncadv.org/STATISTICS'>https://ncadv.org/STATISTICS</a></p><p>Araba Iyanuoluwa .T. <br>EyilZ ☺😊</p><p>Feel free to drop your comments and share 🤗🤗</p>",
        "category": "life",
        "image": blog_pic_5,
        "createdAt": "2020-09-28T07:25:59.789Z",
